import time
from zmoddac1411 import ZMODADC1410
...
def adcDemo(adcZmod, channel, gain, length):
    '''
    ...
    while(True):
        ...
        writeADCData(adcZmod, "buffer_data.csv", acqBuffer, channel, gain, length)
...
def main():
    ...
    adcDemo(adcZmod, 0, 0, TRANSFER_LEN);
